...
const RepositoryStats = ({ item, styles }) => {
    return (
        <View style={styles.statRow}>
            ...
            <Text style={styles.header}>{item.language}</Text>
            <Text style={styles.descriptionText}>Language</Text>
            </View>
            <View style={styles.statColumn}>
            <Text style={styles.header}>{item.stargazersCount}</Text>
            ...
            <View style={styles.statColumn}>
            <Text style={styles.header}>{item.reviewCount}</Text>
            <Text style={styles.descriptionText}>Reviews</Text>
            </View>
            <View style={styles.statColumn}>
            <Text style={styles.header}>{item.ratingAverage}</Text>
